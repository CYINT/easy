...
This directory is the frontend boundary for Easy. The current production UI is still served by Django templates while the project moves to a cleaner backend/frontend split.
